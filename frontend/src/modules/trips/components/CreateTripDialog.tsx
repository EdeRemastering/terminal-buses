...
export const CreateTripDialog = ({ open, onOpenChange }: CreateTripDialogProps) => {
  ...
  return (
    <BaseFormDialog
      ...
      description="Ingresa los datos del viaje para registrar una nueva ruta."
      successTitle="Viaje Programado"
      successDescription="El viaje se registró correctamente en el sistema."
      submitLabel="Programar Viaje"
      submitPendingLabel="Programando..."
      isPending={isPending}
      success={success}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <Popover>
            ...
            <PopoverContent className="w-auto p-0 rounded-2xl" align="start">
              <Calendar mode="single" selected={departureDate} onSelect={setDepartureDate} startMonth={new Date(2025, 0)} endMonth={new Date(2035, 11)} captionLayout="dropdown" autoFocus />
            </PopoverContent>
          </Popover>
        ...
        <div className="space-y-1.5">
          ...
          <Popover>
            ...
            <PopoverContent className="w-auto p-0 rounded-2xl" align="start">
              <Calendar mode="single" selected={arrivalDate} onSelect={setArrivalDate} startMonth={new Date(2025, 0)} endMonth={new Date(2035, 11)} captionLayout="dropdown" autoFocus />
            </PopoverContent>
          </Popover>
